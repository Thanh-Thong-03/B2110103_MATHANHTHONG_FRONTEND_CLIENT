  ...
  <div class="container">
    <div class="login-container">
      ...
      <div>
        ...
        <button @click="register" class="btn btn-login btn-block">Đăng Kí</button>
...
export default {
  setup() {
    const phone = ref();
    const matkhau = ref();
    const nhaplaimatkhau = ref();

    const register = async () => {
      try {
        await userService.register(phone.value, matkhau.value);
      } catch (err) {
        console.log(err);
      }
    };
    return { phone, matkhau, nhaplaimatkhau,register };
  },
};
</script>
